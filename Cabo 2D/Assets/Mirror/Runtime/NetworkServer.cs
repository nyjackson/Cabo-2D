...
namespace Mirror
{
    ...
    public static class NetworkServer
    {
        ...
        public static void SpawnWithClientAuthority(GameObject obj, NetworkConnection ownerConnection = null)
        {
        ...
        public static void Spawn(GameObject obj, GameObject ownerPlayer)
        {
            ...
            SpawnWithClientAuthority(obj, identity.connectionToClient);
        }
        ...
        public static bool SpawnObjects()
        {
            ...
            {
                if (ValidateSceneObject(identity))
                    SpawnWithClientAuthority(identity.gameObject);
            }
            return true;
        }
        ...
        static void Respawn(NetworkIdentity identity)
        {
            if (identity.netId == 0)
            {
                ...
                SpawnWithClientAuthority(identity.gameObject, identity.connectionToClient);
            }
            else
            {
